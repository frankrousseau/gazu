...
def all_task_statuses(client=default):
    ...
    """
    task_statuses = raw.fetch_all("task-status")
...
def all_task_types(client=default):
    ...
    """
    task_types = raw.fetch_all("task-types")
...
def get_task(task_id, client=default):
    ...
    return raw.get("data/tasks/%s/full" % task_id["id"])
...
def set_time_spent(task, person, date, duration, client=default):
    ...
    Args:
        task (str / dict, client=default): The task dict or the task ID.
        person (str / dict, client=default): The person who spent the time on given task.
        date (str, client=default): The date for which time spent must be set.
        duration (int, client=default): The duration of the time spent on given task.
...
def add_time_spent(task, person, date, duration, client=default):
    ...
    Args:
        task (str / dict, client=default): The task dict or the task ID.
        person (str / dict, client=default): The person who spent the time on given task.
        date (str, client=default): The date for which time spent must be added.
        duration (int, client=default): The duration to add on the time spent on given task.
...
def remove_comment(comment, client=default):
    ...
    Args:
        comment (str / dict, client=default): The comment dict or the comment ID.
    """
...
def create_preview(task, comment, client=default):
    ...
    Args:
        task (str / dict, client=default): The task dict or the task ID.
        comment (str / dict, client=default): The comment or the comment ID.
...
def upload_preview_file(preview, file_path, client=default):
    ...
    Args:
        task (str / dict, client=default): The task dict or the task ID.
        file_path (str, client=default): Path of the file to upload as preview.
    """
...
def add_preview(task, comment, preview_file_path, client=default):
    ...
    Args:
        task (str / dict, client=default): The task dict or the task ID.
        comment (str / dict, client=default): The comment or the comment ID.
        preview_file_path (str, client=default): Path of the file to upload as preview.
...
def set_main_preview(preview_file, client=default):
    ...
    Args:
        preview_file (str / dict, client=default): The preview file dict or ID.
...
def all_comments_for_task(task, client=default):
    ...
    """
    task = normalize_model_parameter(task)
    return raw.fetch_all("tasks/%s/comments" % task["id"])
...
def assign_task(task, person, client=default):
    ...
    Args:
        task (str / dict, client=default): The task dict or the task ID.
        person (str / dict, client=default): The person dict or the person ID.
...
def new_task_type(name, client=default):
    ...
    Args:
        name (str, client=default): The name of the task type
...
def new_task_status(name, short_name, color, client=default):
    ...
    Args:
        name (str, client=default): The name of the task status
        short_name (str, client=default): The short name of the task status
        color (str, client=default): The color of the task status has an hexadecimal string
...
def update_task(task, client=default):
    ...
    Args:
        task (dict, client=default): The task dict to update.
...
def update_task_data(task, data={}, client=default):
    ...
    Args:
        task (dict / ID, client=default): The task dict or ID to save in database.
        data (dict, client=default): Free field to set metadata of any kind.
...
def get_task_url(task, client=default):
    ...
    Returns:
        url (str, client=default): Web url associated to the given task
    """
    task = normalize_model_parameter(task)
